...
The rest of the current Rhizome workbench is concentrated in `src/pages/RhizomePage.tsx` and its CSS module. This is a known stabilization concern, not a recommended component model. Extract only along clear ownership boundaries such as:

- workbench shell and sticky regions;
- thread navigator;
- conversation timeline;
- composer and context controls;
- session-start cards;
- interaction/review workspace.
